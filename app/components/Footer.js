        ...
        <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
          <div className="lg:w-1/6 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-400 hover:text-white">Logo Design</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Brand Identity</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Web Design</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Print Design</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/6 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">PORTFOLIO</h2>
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-400 hover:text-white">Logo Designs</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Web Projects</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Print Materials</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Client Work</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/6 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-400 hover:text-white">My Process</a>
              </li>
              <li>
          ...
          <div className="lg:w-1/6 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-400 hover:text-white">Behance</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/6 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-400 hover:text-white">Pinterest</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Dribbble</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">YouTube</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/6 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-400 hover:text-white">Subscribe to my Newsletter</a>
              </li>
            </nav>
          </div>
        </div>
        ...
        <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
          <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
            <div className="relative sm:w-64 w-40 sm:mr-4 mr-2">
              ...
              <input type="email" id="footer-field" name="footer-field" className="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:ring-2 focus:ring-indigo-900 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Enter your email" />
            </div>
            ...
            <p className="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 text-center sm:text-left">Thank you for visiting my portfolio. Stay updated with my latest projects!</p>
          </div>
